...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2026, 1, 1, 23, 0);
        long limit = 3;
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20260101");
        ...
        assertThat(hotArticleListRepository.readAll("20260101")).isEmpty();
    }
}
